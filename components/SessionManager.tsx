                        ...
                        {confirmDeleteId === session.id ? (
                          <>
                            <button
                              ...
                              aria-label={(t as any)('session.confirmDelete')}
                            >
                            ...
                            <button
                              ...
                              aria-label={(t as any)('session.cancel')}
                            >
                              <X className="w-4 h-4" />
                            </button>
                          </>
                          ...
                          <>
                            <button
                              ...
                              aria-label={(t as any)('session.open')}
                            >
                              <FolderOpen className="w-4 h-4" />
                            </button>
                            <button
                              ...
                              aria-label={(t as any)('session.rename')}
                            >
                            ...
                            <button
                              ...
                              className="p-2 hover:bg-stone-200"
                              aria-label={(t as any)('session.export')}
                            >
                            ...
                            <button
                              ...
                              aria-label={(t as any)('session.delete')}
                            >
